...
class Hello {
	...
	List<Inventory> getAllInventoryEndpoint() throws InterruptedException {
		return getInventory();
	}
	@RequestMapping("/inventory/getById/{id}")
	Inventory getSingleInventoryEndpoint(@PathVariable(value = "id") Long id) throws InterruptedException {
		return getInventoryById(id);
	}

	public Inventory getInventoryById(Long id) {
		List<Inventory> allI = getInventory();
		return allI.stream().filter(inventory -> inventory.getId().equals(id)).findAny().get();
	}
	...
	public List<Inventory> getInventory() {
		...
		List<Inventory> inventar = new ArrayList<>();
		inventar.add(
				Inventory
						.builder()
